...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      { title: "Privacy Policy — AdEarn" },
      {
        name: "description",
        content:
          "How AdEarn collects, stores and protects your account, earnings and payout information.",
      },
      { property: "og:title", content: "Privacy Policy — AdEarn" },
      { property: "og:description", content: "What data AdEarn stores and why." },
    ],
  }),
  component: Privacy,
});
  ...
  return (
    <LegalPage title="Privacy Policy">
      ...
      <p>
        ...
        tracking once you leave AdEarn.
      </p>
      <h2>Your rights</h2>
      <p>
