  ...
  return (
    <LegalPage title="Privacy Policy">
      ...
      <ul>
        ...
        <li>Earnings data: claimed task bundles, balance and payout history.</li>
        <li>Payout details: bank/wallet name, account number and account name.</li>
      </ul>
      <h2>Task partners</h2>
      <p>
        Our task partners operate the offers you open and apply their own privacy practices and
